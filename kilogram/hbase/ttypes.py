...
class ColumnDescriptor(object):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.compression = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.BOOL:
        ...
        if ftype == TType.STRING:
          self.bloomFilterType = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.I32:
  ...
  def write(self, oprot):
    ...
    if self.compression is not None:
      ...
      oprot.writeString(self.compression.encode('utf-8'))
      oprot.writeFieldEnd()
    ...
    if self.bloomFilterType is not None:
      ...
      oprot.writeString(self.bloomFilterType.encode('utf-8'))
      oprot.writeFieldEnd()
